...
<div align="center">
	<form:form action="/editingTask" method="post" modelAttribute="taskToEdit"  class="form-signin col-md-4">
		<label>Name:</label>
		<form:input type="text" value="${taskToEdit.getName()}" name="name" path="name" class="form-control" width="250px"/>
		<label>Description:</label>
		<form:textarea type="textarea" value="${taskToEdit.getDescription()}" name="description" path="description" class="form-control"/> 
		<label>Dead Line:</label>
		<form:input type="date" name="DeadLine" value="${taskToEdit.getDeadLine()}" path="DeadLine" class="form-control" width="250px"/>
